...
default_debug = "False" if os.environ.get("RENDER") or os.environ.get("RENDER_EXTERNAL_HOSTNAME") else "True"
DEBUG = os.environ.get("DJANGO_DEBUG", default_debug).strip().lower() in ("1", "true", "yes", "on")
...
# Default to Render host if nothing is provided
if not ALLOWED_HOSTS:
    ALLOWED_HOSTS = [
        "kilobyte-note-book.onrender.com",
        ".onrender.com",
        "localhost",
        "127.0.0.1",
    ]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'main.context_processors.folders_processor',
            ],
        },
    },
]
...
# --- Security hardening defaults (safe for production) ---
